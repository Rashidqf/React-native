...
class InboxEvents extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      modalShow: false,
      connectionList: [
        { id: 0, eventImg: IMAGES.eventImage, eventName: "Block Party", userImg: IMAGES.image1, name: "Bryan J", hours: "Starts in 3 hrs", day: "Today", time: "7:30pm - 9:45pm", globeIcon: 1 },
        { id: 1, eventImg: IMAGES.eventImage, eventName: "Family Reunion 23’", eventTitleIcon: IMAGES.notes_icon, userImg: IMAGES.image1, name: "Bryan J", hours: "17 days", day: "Mon, June 1 - Tues, June 7", time: "4 Events" },
        { id: 2, eventImg: IMAGES.eventImage, eventName: "Family Dinner", userImg: IMAGES.image1, name: "Bryan J", hours: "Today", day: "Tues, June 7", time: "7:30pm - 9:45pm", sidenoteName: "Sidenote Name", sidenoteCategory: "Category" },
        { id: 3, eventImg: IMAGES.eventImage, eventName: "Birthday Party", userImg: IMAGES.image1, name: "Bryan J", hours: "Starts in 3 hrs", day: "Today", time: "7:30pm - 9:45pm", lockIcon: 1 },
      ],
      pinnedConnection: [
      ...
      <ImageBackground source={IMAGES.onboardingScreen} style={styles.backgroundImage}>
        <SafeAreaWrapper backgroundColor={theme?.colors?.TRANSPARENT} containerStyle={{ marginLeft: 0, marginRight: 0, marginTop: 100 }}>
          <View style={styles.iconTabNav}>
            ...
            <TouchableOpacity style={styles.iconTabBtn}>
              <Image source={IMAGES.calendar_icon2} style={[styles.iconTabIcon, styles.iconTabIconActive]} />
            </TouchableOpacity>
                ...
                return (
                  <View style={styles.listItem}>
                    <View style={styles.eventImgView}>
                      <Image source={item.eventImg} style={styles.eventImg} />
                    ...
                    <View style={styles.listItemContent}>
                      ...
                      {item.globeIcon ? <Image source={IMAGES.globe_color_icon} style={styles.globeIcon} /> : null}
                      {item.lockIcon ? <Image source={IMAGES.lock} style={styles.globeIcon} /> : null}
                      {item.sidenoteName ?
...
//Connect Everything
export default connect(mapStateToProps, mapDispatchToProps)(InboxEvents);
