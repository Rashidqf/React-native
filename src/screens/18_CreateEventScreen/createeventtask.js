...
class CreateEventTask extends React.Component {
  constructor(props) {
    super(props);
                    ...
                    <View>
                      ...
                      >
                        ...
                        <View style={styles.body}>
                          ...
                          >
                            {this?.props?.route?.params?.selectedTask === undefined
                              ? ' Assign to a user'
...
//Connect Everything
export default connect(mapStateToProps, mapDispatchToProps)(CreateEventTask);
