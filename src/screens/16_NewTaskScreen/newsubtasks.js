...
class NewSubTaskScreen extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      subFrom: null,
      subSelected: '',
      oldSubtasks: [...this.props.route.params.subtasks],
  ...
  initialValues = {
    ...
    description: this?.state?.subDescrption,
    date: this?.state?.subDate,
    // date: '',
    time: this?.state?.subTime,
  ...
  handleSubmit = values => {
    ...
    if (this.props.route.params.subSelected) {
      data = {
        ...
        [`assigned_${this?.props?.route?.params?.subFrom}_name`]: this.props.route.params.subGroupTitle || '',
      };
    }
    this.state.setFieldValue('subtasks', [...this.state.oldSubtasks, data]);
                ...
                {({ values, isValid, touched, errors, handleSubmit, setFieldTouched, setFieldValue, handleChange }) => {
                  ...
                  return (
                    <>
                      ...
                      {this?.state?.groupId || this?.state?.selectedgroup ? (
                        <TouchableOpacity
                          style={styles.listItem}
                          disabled={this?.state?.groupId || this?.state?.selectedgroup}
                          onPress={() =>
...
//Connect Everything
export default connect(mapStateToProps, mapDispatchToProps)(NewSubTaskScreen);
