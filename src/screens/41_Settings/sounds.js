...
class SoundsScreen extends React.Component {
  constructor(props) {
    ...
    this.state = {
      soundsArray: [],
      selectedSound: this?.props?.route?.params?.selectedSound,
      selectedS: this?.props?.route?.params?.selectedSound,
    };
  }
...
//Connect Everything
export default connect(mapStateToProps, mapDispatchToProps)(SoundsScreen);
