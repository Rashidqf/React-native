...
interface ButtonTextStyleParams extends TextStyleParams {}
...
const styles: {[key: string]: any} = {
  ...
  fillBtnStyle: (
    ...
    return {
      ...
      width: typeof width === 'number' ? Responsive.getWidth(width) : '100%',
  ...
  imageStyle: (size: number, color?: string): any => {
    return {
...
const newStyle: {[key: string]: any} = {
  ...
  safeareaHeaderSize: 100 - (initialWindowSafeAreaInsets?.top ?? 0),
  container: {
    flex: 1,
  ...
  h4: {
    ...STYLES.textStyle(15, COLORS.WHITE, 'BOLD', 'center'),
  },
  h5: {
...
export const COMMON_STYLE = StyleSheet.create(newStyle);
